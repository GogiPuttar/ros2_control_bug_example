...
: ${AMENT_CURRENT_PREFIX:="/root/ros2_control_bug_example/install/example_pkg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/example_pkg/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/example_pkg/environment/path.sh"
